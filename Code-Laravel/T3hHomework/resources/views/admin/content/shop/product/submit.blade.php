            ...
            <div class="form-three widget-shadow">
                <form name="category" action="{{route('add-product-post')}}" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="slug" class="form-control1" id="fileinput" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="priceCore" class="" id="priceCoreinput" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="priceSaleinput" class="col-sm-2 control-label">Giá sale</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="priceSale" class="" id="priceSaleinput" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="stockinput" class="col-sm-2 control-label">Hàng tồn</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="stock" class="" id="stockinput" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="categoryinput" class="col-sm-2 control-label">Danh mục</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="cat_id" class="" id="categoryinput" >
                        </div>
                    </div>
