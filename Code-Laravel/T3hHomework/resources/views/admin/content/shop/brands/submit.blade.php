    ...
    <div class="container">
        <div class="row">
            <div class="form-three widget-shadow">
                ...
                <form name="brand" action="{{route('add-brand-post')}}" method="post" class="form-horizontal">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="link" value="{{old('link')}}" class="form-control1" id="fileinput" placeholder="slug">
                        </div>
                    </div>
                    <div class="form-group">
