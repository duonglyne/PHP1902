            ...
            <div class="single-page-row" id="detail-21">
                <div class="col-md-6 single-top-left">
                    <div class="flexslider">
                            ...
                            <ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(-357px, 0px, 0px);">
                ...
                <div class="col-md-6 single-top-right">
                    ...
                    <div class="single-price">
                        <ul>
                            ...
                            ?>
                            <?php if ($discount > 0) : ?>
                            <li><span class="w3off">{{ (int)$discount }}% OFF</span></li>
                            <?php endif; ?>
                            <li>Ends on: Oct,15th</li>
                            <li><a href="#"><i class="fa fa-gift" aria-hidden="true"></i> Coupon</a></li>
                        </ul>
                    </div>
                    <p class="single-price-text"><?php echo $product->intro ?></p> </p>
